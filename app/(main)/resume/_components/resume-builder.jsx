...
const ResumeBuilder = ({ initialContent }) => {
    ...
    const getCombinedContent = () => {
        ...
        return [
            ...
            skills && `## Skills\n${skills}`,
            entriesToMarkdownEDU(education, "Education"),
            entriesToMarkdownWE(experience, "Work Experience"),
            entriesToMarkdownPRO(projects, "Projects"),
        ]
            .filter(Boolean)
            .join("\n\n");
    };
    ...
    const generatePDF = async () => {
        ...
        try {
            ...
            const opt = {
                ...
                html2canvas: { scale: 2, useCORS: true, enableLinks: true },
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <Textarea
                                        {...field}
                                        className="h-32"
                                        placeholder="List your key skills (eg. JavaScript, Python)"
                                        error={errors.skills}
                                    />
                                )}
                            />
