        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <Badge variant="outline">
                    Last updated:
                    <span suppressHydrationWarning> {format(new Date(insights.lastUpdated), "dd/MM/yyyy")}</span>
                </Badge>
            </div>
                ...
                <Card className="border-2 hover:border-primary hover:scale-105 transition-all duration-300">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            Next update <span suppressHydrationWarning>
                                                ...
                                                <div className="bg-background border rounded-lg p-2 shadow-md">
                                                    ...
                                                    {payload.map((item) => (
                                                        <p key={item.name} className="text-sm">
                                                            {item.name}: ₹{item.value}K per annum
                                                        </p>
                                                    ))}
                                                </div>
                                            );
